			...
			<div class="row">
				<div class="col-sm-7">
					...
					if(mysqli_num_rows($result)==0){
						echo "<form method='POST' action='action_buy.php'>
							...
							<input type='hidden' name='trans_type' value='coursedoc'>
							<input type='hidden' name='LID' value='".$LID."'>
						</form>";
					}
					else{
						echo " <a class='btn btn-primary' style='width:100%; font-size:24px; margin-bottom:10px;' href='uploads/".$LID.".pdf' download>Download file</a> ";					
					}
